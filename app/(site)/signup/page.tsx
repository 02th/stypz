...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
      <div className="absolute top-[-15%] right-[-10%] w-[50%] h-[50%] bg-indigo-100/60 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-15%] left-[-10%] w-[40%] h-[40%] bg-blue-100/60 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-white/70 backdrop-blur-2xl border border-white/80 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-3xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 font-medium mt-2">Start deploying infrastructure in minutes</p>
          </div>
